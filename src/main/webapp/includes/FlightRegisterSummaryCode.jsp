...
<%
Object IdCardNumber = request.getAttribute("PassenIdCardNumber");
/*out.print(IdCardNumber);*/
...
try {
	...
	String query = "select passenger_details.Flight_Id, flight_details.Flight_Name, flight_details.Source, flight_details.Destination, flight_details.Date_of_travel, flight_details.Time_of_Departure, passenger_details.Passenger_Name, passenger_details.Passenger_Age, passenger_details.Passenger_Gender, passenger_details.Passenger_Number_of_Person_Travel, passenger_details.Passenger_Mobile, passenger_details.Passenger_Card_Type, passenger_details.Passenger_Card_Number, flight_details.Flight_Price from flight_details inner join passenger_details on flight_details.Flight_Id=passenger_details.Flight_Id and passenger_details.Passenger_Card_Number='" + IdCardNumber + "';";
	...
	while(rs.next()) {
%>
<form action="TicketBooked.jsp" method="get">
<div class="table-responsive">
  ...
  <tbody class="table-group-divider table-divider-color">
    <tr>
      ...
      <td><i class="fa-solid fa-indian-rupee-sign"></i> <% out.print(rs.getString(14)); %></td>
      <td><button type="submit" class="availableFlightBtn"><span>Confirm</span></button></td>
    </tr>
  </tbody>
  </table>
</div>
